  ...
  #   end
    ...
    task :update_crontab do
      on roles :all do
        ...
        # execute "cd #{release_path} && #{try_sudo} GEM_HOME=/opt/local/ruby/gems RAILS_ENV=#{} bundle exec whenever --clear-crontab #{application} --user #{ubuntu}"
        # execute "cd #{release_path} && #{try_sudo} GEM_HOME=/opt/local/ruby/gems RAILS_ENV=production bundle exec whenever --update-crontab #{application} --user #{ubuntu}"
        execute "export PATH=$PATH:/usr/local/share/gems/gems/railties-4.2.1/lib/rails/generators/rails/app/templates/bin:/home/centos/.rbenv/versions/2.0.0-p598/bin:/home/centos/.rbenv/versions/2.0.0-p598/lib/ruby/gems/2.0.0/gems/bundler-1.9.5/bin:/home/centos/.rbenv/versions/2.0.0-p598/lib/ruby/gems/2.0.0/gems/bundler-1.9.5/lib/bundler/man:/home/centos/.gem/ruby/gems/bundler-1.9.4/bin:/home/centos/.gem/ruby/gems/bundler-1.9.4/lib/bundler/man:/home/centos/.gem/ruby/gems/railties-4.2.0/lib/rails/generators/rails/app/templates/bin:/home/centos/.gem/ruby/gems/web-console-2.1.2/test/dummy/bin:/home/centos/.gem/ruby/gems/bundler-1.9.5/bin:/home/centos/.gem/ruby/gems/bundler-1.9.5/lib/bundler/man:/home/centos/.gem/ruby/gems/bundler-1.9.6/bin:/home/centos/.gem/ruby/gems/bundler-1.9.6/lib/bundler/man:/home/centos/bin:/usr/local/share/gems/gems && cd #{release_path} && gem install bundler && bundle install --deployment && bundle exec whenever --update-crontab store"
      end  
    end
  end 
